...
INSERT INTO `__new_asset_to_project`("id", "asset_id", "project_id", "borrower_id", "amount", "note", "status", "start_date", "end_date", "created_at", "updated_at", "deleted_at") SELECT "id", "asset_id", "project_id", "borrower_id", "amount", "note", "status", "start_date", "end_date", "created_at", "updated_at", "deleted_at" FROM `asset_to_project`;--> statement-breakpoint
...
ALTER TABLE `project` ADD `is_pinned` integer DEFAULT false;--> statement-breakpoint
