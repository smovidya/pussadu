/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 1ef6a13e8e94595349b09d91df7e86ef)
// Runtime types generated with workerd@1.20260120.0 2025-08-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../.svelte-kit/cloudflare/_worker");
	}
	interface Env {
		PUSSADU_KV: KVNamespace;
		PUSSADU_R2: R2Bucket;
		PUSSADU_DB: D1Database;
		ANON_IMAGE_ACCESS_RATE_LIMIT: RateLimit;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_TITLE" | "PUBLIC_BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "DATABASE_URL" | "PUBLIC_GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
